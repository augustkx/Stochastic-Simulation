# -*- coding: utf-8 -*-
"""
Created on Wed Nov 11 07:09:05 2015
...
def main():
    ...
    for sample in range(500,50500,100):
    ...
    plt.savefig('Pure random.png')
    print array_mean_area
    print time.clock()

    np.savetxt('Pure random Sampling_s.txt', array_n)
    np.savetxt('Pure random Sampling_change_mean_s.txt',change)
    np.savetxt('Pure random Sampling_mean_s.txt',array_mean_area)
